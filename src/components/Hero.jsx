...
const Main = () => {
  return (
    <section className="relative py-8 px-6 lg:p-20">
    <div className="flex flex-col-reverse items-center w-full lg:flex-row lg:justify-between lg:items-start">
        <div className="mt-12 text-center max-w-sm mx-auto sm:max-w-lg lg:max-w-xl lg:w-1/2 lg:text-left">
      ...
      <div className="lg:w-1/2">
        ...
        <div className="absolute right-0 top-20 bg-SoftBlue w-[80%] h-[33%] rounded-tl-full rounded-bl-full -z-10 sm:h-[45%] sm:top-28 lg:w-[37%] lg:h-[54%] lg:top-48"></div>
      </div>
    </div>
    </section>
  );
