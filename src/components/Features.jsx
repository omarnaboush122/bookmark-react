...
const Features = () => {
  ...
  return (
    ...
    <article className="mt-20 flex flex-col items-center lg:flex-row lg:w-[1000px] lg:h-[420px] lg:mx-auto">
      ...
      <div className="max-w-[400px] mx-auto text-center mt-24 sm:mt-32 lg:mt-0 lg:ml-16 lg:text-left lg:max-w-[480px]">
        ...
        <button className="hidden lg:block lg:text-white lg:bg-SoftBlue lg:py-4 lg:px-8 lg:rounded-md lg:border lg:hover:bg-white lg:hover:border-SoftBlue lg:hover:text-SoftBlue transition-all duration-300">More Info</button>
      </div>
    </article>
    </section>
  );
